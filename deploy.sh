...
# Pastikan script ini dijalankan dari dalam root folder project (MARIS)

# Konfigurasi Path (Sesuaikan jika perlu)
# Asumsi: Folder project 'MARIS' dan 'public_html' berada di level yang sama di hosting
PROJECT_FOLDER="MARIS"
PUBLIC_HTML_PATH="../public_html"

echo "========================================"
echo "🚀 Memulai Deployment MARIS"
echo "========================================"
